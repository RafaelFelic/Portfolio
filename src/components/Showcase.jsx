...
export default function Showcase() {
  ...
  return (
    <div ref={sectionRef} className="h-screen flex flex-col md:flex-row">
      <section className="block md:inline-block md:m-auto pr-5 my-8 md:ml-12 w-full md:w-[50%] text-3xl md:text-3xl text-right md:text-left font-semibold">
        <div>
          <p className="hide fromleft mb-3 md:mb-8">Welcome!</p>
          <p className="hide fromleft mb-2 md:mb-6">
            I am{' '}
            <span className="text-[#4169E1] text-4xl md:text-4xl">
              Rafael Feliciano
            </span>
            ,
          </p>
      ...
      <section className="md:w-[50%] w-[85%] mx-auto md:m-auto md:mr-12 text-md md:text-lg bg-gray-400 text-black p-2.5 shadow-[20px_20px_0px_2px_#000] hide fromright">
